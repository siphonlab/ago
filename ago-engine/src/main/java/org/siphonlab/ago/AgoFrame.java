...
public class AgoFrame extends CallFrame<AgoFunction>{
    ...
    */
    protected boolean evaluateTryCatch(Slots slots, int instruction){
        switch (instruction){
            ...
            case TryCatch.except_throw_if_v: {
                var exception = slots.getObject(code[pc++]);
                if(exception != null){
                    if(!this.handleException(exception)) return false;  // not handled, exit
                }
            }
            break;
        }
    ...
    protected int evaluateInstanceOf(Slots slots, int pc, int instruction) {
        switch (instruction){
            case InstanceOf.instanceof_i_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == INT); pc++; break;
            case InstanceOf.instanceof_S_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == STRING); pc++; break;
            case InstanceOf.instanceof_B_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == BOOLEAN); pc++; break;
            case InstanceOf.instanceof_c_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == CHAR); pc++; break;
            case InstanceOf.instanceof_f_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == FLOAT); pc++; break;
            case InstanceOf.instanceof_d_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == DOUBLE); pc++; break;
            case InstanceOf.instanceof_D_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == DECIMAL); pc++; break;
            case InstanceOf.instanceof_b_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == BYTE); pc++; break;
            case InstanceOf.instanceof_s_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == SHORT); pc++; break;
            case InstanceOf.instanceof_l_vv :  slots.setBoolean(code[pc++], agoClass.getSlotDefs()[code[pc++]].getTypeCode() == LONG); pc++; break;
            //case InstanceOf.instanceof_C_vvC :  slots.setBoolean(code[pc++], agoClass.slotsCreator.getSlotType(code[pc++]) == .class); break;
            case InstanceOf.instanceof_o_vvC:  {
                var target = code[pc++];
                var slotType = agoClass.getSlotDefs()[code[pc]];
                if(slotType.getTypeCode() == OBJECT){
...
//                case Or.or_vov:     slots.setBoolean(code[pc], slots.getBoolean(code[pc++]) || slots.getObject(code[pc++]).getSlots().getBoolean(code[pc++])); break;
    ...
    protected int evaluateIncDec(final Slots slots,  int pc, final int instruction){
        switch (instruction){
            ...
            case IncDec.inc_f_ovc  :  slots.getObject(code[pc++]).getSlots().incFloat(code[pc++], Float.intBitsToFloat(code[pc++]));       break;
            case IncDec.inc_f_ovv :  slots.getObject(code[pc++]).getSlots().incFloat(code[pc++], slots.getFloat(code[pc++])); break;
            case IncDec.inc_d_ovcc  :  slots.getObject(code[pc++]).getSlots().incDouble(code[pc++], toDouble(code[pc++], code[pc++]));       break;
            case IncDec.inc_d_ovv:  slots.getObject(code[pc++]).getSlots().incDouble(code[pc++], slots.getDouble(code[pc++]));       break;
            case IncDec.inc_D_ovc  :  slots.getObject(code[pc++]).getSlots().incDecimal(code[pc++], engine.toDecimal(code[pc++]));       break;
            case IncDec.inc_D_ovv:  slots.getObject(code[pc++]).getSlots().incDecimal(code[pc++], slots.getDecimal(code[pc++]));       break;
            case IncDec.inc_b_ovc  :  slots.getObject(code[pc++]).getSlots().incByte(code[pc++], (byte) code[pc++]);       break;
            case IncDec.inc_b_ovv:  slots.getObject(code[pc++]).getSlots().incByte(code[pc++], slots.getByte(code[pc++]));       break;
            case IncDec.inc_s_ovc  :  slots.getObject(code[pc++]).getSlots().incShort(code[pc++], (short) code[pc++]);       break;
            case IncDec.inc_s_ovv:  slots.getObject(code[pc++]).getSlots().incShort(code[pc++], slots.getShort(code[pc++]));      break;
            case IncDec.inc_l_ovcc  :  slots.getObject(code[pc++]).getSlots().incLong(code[pc++], toLong(code[pc++], code[pc++]));        break;
            case IncDec.inc_l_ovv:  slots.getObject(code[pc++]).getSlots().incLong(code[pc++], slots.getLong(code[pc++]));       break;
        }
        return pc;
    }
    protected int evaluateNeg(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case Neg.neg_D_vv: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).negate()); break;
    ...
    protected int evaluateMod(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case Mod.mod_D_vc:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).remainder(engine.toDecimal(code[pc++]))); break;
            case Mod.mod_D_vvc: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).remainder(engine.toDecimal(code[pc++]))); break;
            case Mod.mod_D_vv:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).remainder(slots.getDecimal(code[pc++]))); break;
            case Mod.mod_D_vvv: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).remainder(slots.getDecimal(code[pc++]))); break;
            case Mod.mod_D_vcv: slots.setDecimal(code[pc++], engine.toDecimal(code[pc++]).remainder(slots.getDecimal(code[pc++]))); break;
    ...
    protected int evaluateDiv(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case Div.div_D_vc:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).divide(engine.toDecimal(code[pc++]))); break;
            case Div.div_D_vvc: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).divide(engine.toDecimal(code[pc++]))); break;
            case Div.div_D_vv:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).divide(slots.getDecimal(code[pc++]))); break;
            case Div.div_D_vvv: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).divide(slots.getDecimal(code[pc++]))); break;
            case Div.div_D_vcv: slots.setDecimal(code[pc++], engine.toDecimal(code[pc++]).divide(slots.getDecimal(code[pc++]))); break;
        }
        return pc;
    }
    protected int evaluateMultiply(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case Multiply.mul_D_vc:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).multiply(engine.toDecimal(code[pc++]))); break;
            case Multiply.mul_D_vvc: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).multiply(engine.toDecimal(code[pc++]))); break;
            case Multiply.mul_D_vv:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).multiply(slots.getDecimal(code[pc++]))); break;
            case Multiply.mul_D_vvv: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).multiply(slots.getDecimal(code[pc++]))); break;
    ...
    protected int evaluateSub(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case Subtract.sub_D_vc:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).subtract(engine.toDecimal(code[pc++]))); break;
            case Subtract.sub_D_vvc: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).subtract(engine.toDecimal(code[pc++]))); break;
            case Subtract.sub_D_vv:  slots.setDecimal(code[pc], slots.getDecimal(code[pc++]).subtract(slots.getDecimal(code[pc++]))); break;
            case Subtract.sub_D_vvv: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).subtract(slots.getDecimal(code[pc++]))); break;
            case Subtract.sub_D_vcv: slots.setDecimal(code[pc++], engine.toDecimal(code[pc++]).subtract(slots.getDecimal(code[pc++]))); break;
    ...
    protected int evaluateLittleEquals(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case LittleEquals.le_D_vvc: slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(engine.toDecimal(code[pc++])) <= 0); break;
            case LittleEquals.le_D_vvv:  slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(slots.getDecimal(code[pc++])) <= 0); break;
    ...
    protected int evaluateGreaterEquals(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case GreaterEquals.ge_D_vvc: slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(engine.toDecimal(code[pc++])) >= 0); break;
            case GreaterEquals.ge_D_vvv:  slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(slots.getDecimal(code[pc++])) >= 0); break;
    ...
    protected int evaluateGreaterThan(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case GreaterThan.gt_D_vvc: slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(engine.toDecimal(code[pc++])) > 0); break;
            case GreaterThan.gt_D_vvv:  slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(slots.getDecimal(code[pc++])) > 0); break;
    ...
    protected int evaluateNotEquals(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case NotEquals.ne_D_vvc: slots.setBoolean(code[pc++], !slots.getDecimal(code[pc++]).equals(engine.toDecimal(code[pc++]))); break;
            case NotEquals.ne_D_vvv:  slots.setBoolean(code[pc++], !slots.getDecimal(code[pc++]).equals(slots.getDecimal(code[pc++]))); break;
            ...
            case NotEquals.ne_u_vvn: slots.setBoolean(code[pc++], slots.getUnion(code[pc++]) != null); break;
            case NotEquals.ne_u_vvv: slots.setBoolean(code[pc++], !Objects.equals(slots.getUnion(code[pc++]), slots.getUnion(code[pc++]))); break;
        }
        return pc;
    }
    protected int evaluateEquals(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case Equals.equals_D_vvc: slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).equals(engine.toDecimal(code[pc++]))); break;
            case Equals.equals_D_vvv:  slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).equals(slots.getDecimal(code[pc++]))); break;
            ...
            case Equals.equals_u_vvn: slots.setBoolean(code[pc++], slots.getUnion(code[pc++]) == null); break;
            case Equals.equals_u_vvv: slots.setBoolean(code[pc++], Objects.equals(slots.getUnion(code[pc++]), slots.getUnion(code[pc++]))); break;
        }
        return pc;
    }
    protected int evaluateBox(final Slots slots, int pc, final int instruction){
        switch (instruction){
            ...
            case Box.box_D_vc:              slots.setObject(code[pc++], engine.getBoxer().boxDecimal(engine.toDecimal(code[pc++])));break;
    ...
    protected int evaluateArray(Slots slots, int pc, int instruction) {
        switch (instruction){
            ...
            case Array.array_put_D_acc:     ((DecimalArrayInstance)slots.getObject(code[pc++])).value[code[pc++]] = engine.toDecimal(code[pc++]); break;
    ...
    protected int evaluateReturn(CallFrame<?> self, Slots slots, int pc, int instruction) {
        switch (instruction){
            ...
            case Return.return_D_c:     {self.finishDecimal(engine.toDecimal(code[pc++])); break;}
    ...
    protected int evaluateLittleThan(final Slots slots, int pc, final int instruction) {
        switch (instruction){
                ...
                case LittleThan.lt_D_vvc: slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(engine.toDecimal(code[pc++])) < 0); break;
                case LittleThan.lt_D_vvv:  slots.setBoolean(code[pc++], slots.getDecimal(code[pc++]).compareTo(slots.getDecimal(code[pc++])) < 0); break;
    ...
    protected int evaluateAdd(Slots slots,  int pc, int instruction) {
        switch (instruction){
                ...
                case Add.add_D_vc:  slots.incDecimal(code[pc++], engine.toDecimal(code[pc++])); break;
                case Add.add_D_vvc: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).add(engine.toDecimal(code[pc++]))); break;
                case Add.add_D_vv:  slots.incDecimal(code[pc++], slots.getDecimal(code[pc++])); break;
                case Add.add_D_vvv: slots.setDecimal(code[pc++], slots.getDecimal(code[pc++]).add(slots.getDecimal(code[pc++]))); break;
    ...
    protected int evaluateConst(Slots slots, int pc, int instruction) {
        switch (instruction){
            ...
            case Const.const_D_vc : slots.setDecimal(code[pc++], engine.toDecimal(code[pc++])); break;
            case Const.const_fld_D_ovc: slots.getObject(code[pc++]).getSlots().setDecimal(code[pc++], engine.toDecimal(code[pc++]));   break;
            ...
            case Const.const_nu_v: slots.setUnion(code[pc++], null); break;
            case Const.const_fld_nu_ov: slots.getObject(code[pc++]).getSlots().setUnion(code[pc++], null); break;

            case Const.const_no_v: slots.setObject(code[pc++], null); break;
            case Const.const_fld_no_ov: slots.getObject(code[pc++]).getSlots().setObject(code[pc++], null); break;
    ...
    protected int evaluateCast(CallFrame<?> self, Slots slots, int pc, int instruction){
        switch (instruction){
            ...
            case Cast.u2o: return validateNullForUnion(self, slots.getUnion(code[pc+1]), OBJECT, instruction);
            case Cast.u2c: return validateNullForUnion(self, slots.getUnion(code[pc+1]), CHAR, instruction);
            case Cast.u2f: return validateNullForUnion(self, slots.getUnion(code[pc+1]), FLOAT, instruction);
            case Cast.u2d: return validateNullForUnion(self, slots.getUnion(code[pc+1]), DOUBLE, instruction);
            case Cast.u2b: return validateNullForUnion(self, slots.getUnion(code[pc+1]), BYTE, instruction);
            case Cast.u2s: return validateNullForUnion(self, slots.getUnion(code[pc+1]), SHORT, instruction);
            case Cast.u2i: return validateNullForUnion(self, slots.getUnion(code[pc+1]), INT, instruction);
            case Cast.u2l: return validateNullForUnion(self, slots.getUnion(code[pc+1]), LONG, instruction);
            case Cast.u2C: return validateNullForUnion(self, slots.getUnion(code[pc+1]), CLASS_REF, instruction);
            case Cast.u2D: return validateNullForUnion(self, slots.getUnion(code[pc+1]), DECIMAL, instruction);
    ...
    private int validateNullForUnion(CallFrame<?> self, Object union, TypeCode typeCode, int reenterState) {
        if(union == null) {
            raiseException(self, "lang.ClassCastException", "can't cast null to '%s'".formatted(typeCode));
            return -1;
        } else {
            reenter(null, reenterState);
            return pc;
        }
    }
        ...
        if(TypeCode.isPrimitive(srcTypeCode)){   // primitive src
            if(TypeCode.isPrimitive(targetTypeCode)){
                ...
                if(targetClass instanceof AgoEnum agoEnum){
                    ...
                    validateClassInheritance(instance.getAgoClass(), targetClass);
                    slots.setObject(targetIndex, instance);
                }
            }
        } else {
    ...
    protected void reenter(WaitingReentrantFrame<?> waitingReentrantFrame, int instruction) {
        switch (instruction){
            ...
            case Cast.u2o:
                slots.setObject(code[pc++], (Instance<?>) slots.getUnion(code[pc++]));
                break;

            case Cast.u2c:
                slots.setChar(code[pc++], Union.unionToChar(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2f:
                slots.setFloat(code[pc++], Union.unionToFloat(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2d:
                slots.setDouble(code[pc++], Union.unionToDouble(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2b:
                slots.setByte(code[pc++], Union.unionToByte(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2s:
                slots.setShort(code[pc++], Union.unionToShort(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2i:
                slots.setInt(code[pc++], Union.unionToInt(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2l:
                slots.setLong(code[pc++], Union.unionToLong(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2C:
                slots.setClassRef(code[pc++], Union.unionToClassRef(slots.getUnion(code[pc++]), engine));
                break;

            case Cast.u2D:
                slots.setDecimal(code[pc++], Union.unionToDecimal(slots.getUnion(code[pc++]), engine));
                break;
        }
    }
