...
public class RdbSlotsJsonSerializer extends JsonSerializer<DbSlots> {

    private final DbEngine dbEngine;

    public RdbSlotsJsonSerializer(DbEngine dbEngine) {
        this.dbEngine = dbEngine;
    }

    @Override
    public void serialize(DbSlots value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        if(instance != null && instance.getParentScope() != null){
            if(dbEngine.getBoxTypes().isBoxType(instance.getParentScope().getAgoClass())){
