...
public class DereferenceContextAgoFrame<Id> extends AgoFrame implements ObjectRefOwner<Id> {

    public DereferenceContextAgoFrame(DereferenceContextSlots<Id> slots, AgoFunction agoFunction, AgoEngine engine) {
