...
public class NullableTests {
    ...
    @Test
    public void equals() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void if_else() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void and() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void or() throws CompilationError, CompilationErrorsException, IOException {
        run("nullable/or.ago");
        Trace.printOutput();
    ...
    @Test
    public void not() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void compare() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void if_stmt() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void while_stmt() throws CompilationError, CompilationErrorsException, IOException {
        run("nullable/while_stmt.ago");
        Trace.printOutput();
        assertTrue(Trace.outputted("b yes", "b2 no", "b3 no", "b loop", "b loop", "b2 loop", "b3 loop", "b not loop", "b2 not loop", "b2 not loop", "b3 not loop", "b3 not loop", "5", "4", "3", "2", "1", "5"));
    }

    @Test
    public void for_each_stmt() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void with() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void switch_stmt() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void via_stmt() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void narrow() throws CompilationError, CompilationErrorsException, IOException {
        run("nullable/narrow.ago");
        Trace.printOutput();
        assertTrue(Trace.outputted("2027", "2027", "2028", "2027", "2028", "2026", "null"));
    }
