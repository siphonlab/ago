...
public class InterfaceTest {
    ...
    @Test
    public void meta_test() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void configurable_fun_test() throws CompilationError, CompilationErrorsException, IOException {
    ...
    public void constructor_test() throws CompilationError, CompilationErrorsException, IOException {
        ...
        Trace.printOutput();
        assertTrue(Trace.outputted("2", "3", "'I' is an interface, not instantiable", "C is instantiable", "D isn't instantiable"));
    }
