...
public class GenericTest {
    ...
    @Test
    public void intermedia_test() throws CompilationError, CompilationErrorsException, IOException {
        run("generic/intermedia.ago");
        assertTrue(Trace.outputted("Samoyed"));
    }

    @Test
    public void metaclass_test() throws CompilationError, CompilationErrorsException, IOException {
        run("generic/metaclass.ago");
        assertTrue(Trace.outputted("Samoyed"));
    }

    @Test
    public void tuple_test() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void triple_test() throws CompilationError, CompilationErrorsException, IOException {
    ...
    @Test
    public void inner_test() throws CompilationError, CompilationErrorsException, IOException {
        run("generic/inner.ago");
        assertTrue(Trace.outputted("meow", "meow", "tweet", "meow", "meow", "tweet"));
    }

    @Test
    public void inner2_test() throws CompilationError, CompilationErrorsException, IOException {
        run("generic/inner2.ago");
        assertTrue(Trace.outputted("meow", "tweet", "meow", "tweet"));
    }

    @Test
    public void class_constructor_test() throws CompilationError, CompilationErrorsException, IOException {
        run("generic/class_constructor.ago");
        assertTrue(Trace.outputted("Samoyed", "Samoyed", "Samoyed"));
    }

    @Test
    public void function_test() throws CompilationError, CompilationErrorsException, IOException {
        run("generic/function.ago");
        assertTrue(Trace.outputted("1", "woof", "Samoyed"));
    }

    @Test
    public void numbers_test() throws CompilationError, CompilationErrorsException, IOException {
