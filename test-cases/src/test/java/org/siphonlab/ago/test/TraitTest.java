...
public class TraitTest {
    ...
    @Test
    public void permit_test() throws CompilationError, CompilationErrorsException, IOException {
        run("trait/permit.ago");
        assertTrue(Trace.outputted("delay: 1000", "1000", "delay: 1000", "1000", "delay: 3000", "3000", "delay: 3000", "3000"));
    }

    @Test
    public void inherits_test() throws CompilationError, CompilationErrorsException, IOException {
        run("trait/inherits.ago");
        assertTrue(Trace.outputted("A:I'm a", "A:I'm b", "A:I'm b"));
    }

    @Test
    public void generic_test() throws CompilationError, CompilationErrorsException, IOException {
